    ...
    <div className="min-h-screen bg-white flex items-center justify-center p-4">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center transform transition-all duration-500 hover:scale-105">
          ...
          <p className="text-gray-600 text-sm">Your premium e-commerce destination</p>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl shadow-lg p-8 transform transition-all duration-500 hover:shadow-xl">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button type="button" className="flex items-center justify-center px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-all duration-300 transform hover:scale-105 hover:shadow-md">
        ...
        <div className="text-center text-xs text-gray-500">
          ...
          <a href="#" className="hover:text-black transition-colors duration-200 hover:underline">
            Terms of Service
          </a>{' '}
          and{' '}
          <a href="#" className="hover:text-black transition-colors duration-200 hover:underline">
