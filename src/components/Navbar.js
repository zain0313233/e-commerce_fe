...
import { Search, User, HelpCircle, ShoppingCart } from 'lucide-react'

const Navbar = () => {
  return (
    <>
      <div className="bg-green-800 text-white text-center text-sm p-2 font-medium">
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-6">
              ...
              <div className="flex items-center space-x-4 ml-4">
                ...
                <button className="text-gray-700 hover:text-gray-900 relative transition-colors duration-200">
