...
import { Search, User, HelpCircle, ShoppingCart, X, Menu } from 'lucide-react'
          ...
          <div className="flex items-center justify-between h-16">
           ...
           <div className="flex items-center">
            ...
            <div className="flex items-center space-x-2 md:space-x-4">
              ...
              <button className="hidden sm:block text-gray-700 hover:text-gray-900 transition-colors duration-200 p-2 hover:bg-gray-100 rounded-full">
                <HelpCircle size={20} />
              </button>
              <button
